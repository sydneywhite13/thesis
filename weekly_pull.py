'''
program to pull results of each experimental users's discover weekly recommendations (weekly)
this will record all potential relevant attributes from artist gender to danceability, valence, and more
'''
...
def pull(user):
    ...
    if token:
        ...
        filename = f"my_disc_weekly_tracks_wgender_{user}_{date.today()}.csv"
        f = open(filename, "w")
